...
// For more info:
// https://stackoverflow.com/questions/47685388/load-class-from-exploded-module-using-custom-classloader

public class PathLauncher {
    public static void main(String[] args) throws Exception {
        String modulePath = args[0]; // E.g., "build/modules"
        ...
        ModuleLayer ml = ModuleLayer.boot().defineModulesWithOneLoader(cfg, PathLauncher.class.getClassLoader());
